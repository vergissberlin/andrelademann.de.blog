...
title: "Warum KI-Chefs vor dem Weltuntergang warnen – und trotzdem weiterbauen"
slug: warum-ki-chefs-vor-dem-weltuntergang-warnen
locale: de
...
tags:
  - ki
  - zukunft
description: "Altman warnt den US-Kongress vor KI-Risiken und bringt kurz danach das nächste Modell raus. Musk warnt vor der Auslöschung der Zivilisation…"
...
Fangen wir mit der Tatsache an, dass das keine reine Marketing-Show ist. Sam Altman hat [2023 vor dem US-Senat ausgesagt](https://www.judiciary.senate.gov/committee-activity/hearings/oversight-of-ai-rules-for-artificial-intelligence) und Lizenzpflicht sowie Aufsicht für Frontier-KI gefordert. Elon Musk warnt wiederholt vor [„ziviler Zerstörung"](https://www.cnn.com/2023/04/17/tech/elon-musk-ai-warning-tucker-carlson/index.html). Geoffrey Hinton hat Google gezielt verlassen, um frei über die Risiken sprechen zu können, und erzählte [60 Minutes](https://www.cbsnews.com/news/artificial-intelligence-risks-dangers-geoffrey-hinton-60-minutes/), dass er sein Lebenswerk bereut. Hunderte Forscher und Führungskräfte, Musk eingeschlossen, unterzeichneten den [Pause-Letter](https://futureoflife.org/open-letter/pause-giant-ai-experiments/), der eine sechsmonatige Pause bei großen Trainingsläufen forderte. Altman selbst unterschrieb das [CAIS-Statement](https://www.safe.ai/work/statement-on-ai-risk), das das Aussterberisiko durch KI auf eine Stufe mit Pandemien und Atomkrieg stellt.
...
Stell die Warnungen dem Gegenwind gegenüber, denn der ist inhaltlich fundiert, nicht am Rand. Yann LeCun, bis vor Kurzem Chef-KI-Wissenschaftler bei Meta, nennt Weltuntergangs-Rhetorik [„absurd"](https://fortune.com/2023/06/15/yann-lecun-ai-godfather-destroy-humanity-threat) und argumentiert, aktuelle Systeme seien meilenweit von der allgemeinen Fähigkeit entfernt, die die Warnungen unterstellen. Andrew Ng wird noch deutlicher und beschreibt die Extinction-Erzählung eher als [Science-Fiction und PR-Positionierung](https://thenextweb.com/news/andrew-ng-extinction-science-fiction) denn als technische Realität – und weist darauf hin, dass sie bequemerweise von konkreten Schäden ablenkt, die heute schon passieren: verzerrte Einstellungsalgorithmen, Jobverdrängung, ungelöste Urheberrechtsstreitigkeiten und der Energiebedarf immer größerer Trainingsläufe.
